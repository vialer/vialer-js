...
class RTD {
    ...
    constructor() {
        ...
        if (location.pathname.includes('.html') && !location.pathname.includes('index.html') && !location.pathname.includes('tutorial')) {
            this.showApiTab()
        } else {
            this.showManualsTab()
        }
